          ...
          {SOLUTIONS.map((s, i) => {
            ...
            return (
              <Reveal key={s.slug}>
                <article
                  className={cn(
                    "grid grid-cols-1 gap-6 py-10 md:grid-cols-[5fr_6fr] md:gap-14 md:py-14",
                ...
                >
                  <div>
                    ...
                    <Headline as="h3" size="md" className="mt-2 max-w-[20ch]">
                      {s.outcome}
                    </Headline>
                  </div>

                  <div>
                    <p className="max-w-[52ch] font-serif text-[16px] leading-relaxed text-ink-soft">
                      {s.description}
                    </p>
